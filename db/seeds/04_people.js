 ...
 * individuals with made-up names. Replace each with real people —
 * name, role, bio, photo — from Admin > People as soon as you have them.
 */
exports.seed = async function (knex) {
  ...
  const rows = [
    {
      name: 'The Cutters', sort_order: 1, active: true,
    ...
    {
      name: 'The Coat & Jacket Makers', sort_order: 2, active: true,
    ...
    {
      name: 'The Trouser Makers', sort_order: 3, active: true,
    ...
    {
      name: 'Front of House', sort_order: 4, active: true,
